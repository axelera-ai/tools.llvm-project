...
// CHECK-NEXT:     zvvbf16fp32mm        0.1       'Zvvbf16fp32mm' (BFloat16 Inputs, FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvbf16fp64mm        0.1       'Zvvbf16fp64mm' (BFloat16 Inputs, FP64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvbf16mm            0.1       'Zvvbf16mm' (BFloat16 Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvfmm               0.1       'Zvvfmm' (Floating-Point Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvfp16fp32mm        0.1       'Zvvfp16fp32mm' (FP16 Inputs, FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvfp16fp64mm        0.1       'Zvvfp16fp64mm' (FP16 Inputs, FP64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvfp16mm            0.1       'Zvvfp16mm' (FP16 Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvfp32fp64mm        0.1       'Zvvfp32fp64mm' (FP32 Inputs, FP64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvfp32mm            0.1       'Zvvfp32mm' (FP32 Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvfp64mm            0.1       'Zvvfp64mm' (FP64 Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi16i32mm          0.1       'Zvvi16i32mm' (Int16 Inputs, Int32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi16i64mm          0.1       'Zvvi16i64mm' (Int16 Inputs, Int64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi16mm             0.1       'Zvvi16mm' (Int16 Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi32i64mm          0.1       'Zvvi32i64mm' (Int32 Inputs, Int64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi32mm             0.1       'Zvvi32mm' (Int32 Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi4i16mm           0.1       'Zvvi4i16mm' (Int4 Inputs, Int16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi4i32mm           0.1       'Zvvi4i32mm' (Int4 Inputs, Int32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi4i8mm            0.1       'Zvvi4i8mm' (Int4 Inputs, Int8 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi64mm             0.1       'Zvvi64mm' (Int64 Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi8i16mm           0.1       'Zvvi8i16mm' (Int8 Inputs, Int16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi8i32mm           0.1       'Zvvi8i32mm' (Int8 Inputs, Int32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi8i64mm           0.1       'Zvvi8i64mm' (Int8 Inputs, Int64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvi8mm              0.1       'Zvvi8mm' (Int8 Matrix Multiply-Accumulate)
...
// CHECK-NEXT:     zvvofp4bf16mm        0.1       'Zvvofp4bf16mm' (OFP4 Inputs, BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvofp4fp16mm        0.1       'Zvvofp4fp16mm' (OFP4 Inputs, FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvofp4fp32mm        0.1       'Zvvofp4fp32mm' (OFP4 Inputs, FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvofp4ofp8mm        0.1       'Zvvofp4ofp8mm' (OFP4 Inputs, OFP8 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvofp8bf16mm        0.1       'Zvvofp8bf16mm' (OFP8 Inputs, BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvofp8fp16mm        0.1       'Zvvofp8fp16mm' (OFP8 Inputs, FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvofp8fp32mm        0.1       'Zvvofp8fp32mm' (OFP8 Inputs, FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvofp8fp64mm        0.1       'Zvvofp8fp64mm' (OFP8 Inputs, FP64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvofp8mm            0.1       'Zvvofp8mm' (OFP8 Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxi4bf16mm         0.1       'Zvvxi4bf16mm' (MXINT4 Inputs (BS=32), BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxi4fp16mm         0.1       'Zvvxi4fp16mm' (MXINT4 Inputs (BS=32), FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxi4fp32mm         0.1       'Zvvxi4fp32mm' (MXINT4 Inputs (BS=32), FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxi8bf16mm         0.1       'Zvvxi8bf16mm' (MXINT8 Inputs (BS=32), BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxi8fp16mm         0.1       'Zvvxi8fp16mm' (MXINT8 Inputs (BS=32), FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxi8fp32mm         0.1       'Zvvxi8fp32mm' (MXINT8 Inputs (BS=32), FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxi8fp64mm         0.1       'Zvvxi8fp64mm' (MXINT8 Inputs (BS=32), FP64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxni4bf16mm        0.1       'Zvvxni4bf16mm' (MXINT4 Inputs (BS=16), BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxni4fp16mm        0.1       'Zvvxni4fp16mm' (MXINT4 Inputs (BS=16), FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxni4fp32mm        0.1       'Zvvxni4fp32mm' (MXINT4 Inputs (BS=16), FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxni8bf16mm        0.1       'Zvvxni8bf16mm' (MXINT8 Inputs (BS=16), BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxni8fp16mm        0.1       'Zvvxni8fp16mm' (MXINT8 Inputs (BS=16), FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxni8fp32mm        0.1       'Zvvxni8fp32mm' (MXINT8 Inputs (BS=16), FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxni8fp64mm        0.1       'Zvvxni8fp64mm' (MXINT8 Inputs (BS=16), FP64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxnofp4bf16mm      0.1       'Zvvxnofp4bf16mm' (MXFP4 Inputs (BS=16), BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxnofp4fp16mm      0.1       'Zvvxnofp4fp16mm' (MXFP4 Inputs (BS=16), FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxnofp4fp32mm      0.1       'Zvvxnofp4fp32mm' (MXFP4 Inputs (BS=16), FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxnofp4ofp8mm      0.1       'Zvvxnofp4ofp8mm' (MXFP4 Inputs (BS=16), OFP8 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxnofp8bf16mm      0.1       'Zvvxnofp8bf16mm' (MXFP8 Inputs (BS=16), BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxnofp8fp16mm      0.1       'Zvvxnofp8fp16mm' (MXFP8 Inputs (BS=16), FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxnofp8fp32mm      0.1       'Zvvxnofp8fp32mm' (MXFP8 Inputs (BS=16), FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxnofp8fp64mm      0.1       'Zvvxnofp8fp64mm' (MXFP8 Inputs (BS=16), FP64 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxofp4bf16mm       0.1       'Zvvxofp4bf16mm' (MXFP4 Inputs (BS=32), BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxofp4fp16mm       0.1       'Zvvxofp4fp16mm' (MXFP4 Inputs (BS=32), FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxofp4fp32mm       0.1       'Zvvxofp4fp32mm' (MXFP4 Inputs (BS=32), FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxofp4ofp8mm       0.1       'Zvvxofp4ofp8mm' (MXFP4 Inputs (BS=32), OFP8 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxofp8bf16mm       0.1       'Zvvxofp8bf16mm' (MXFP8 Inputs (BS=32), BFloat16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxofp8fp16mm       0.1       'Zvvxofp8fp16mm' (MXFP8 Inputs (BS=32), FP16 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxofp8fp32mm       0.1       'Zvvxofp8fp32mm' (MXFP8 Inputs (BS=32), FP32 Accumulator Matrix Multiply-Accumulate)
// CHECK-NEXT:     zvvxofp8fp64mm       0.1       'Zvvxofp8fp64mm' (MXFP8 Inputs (BS=32), FP64 Accumulator Matrix Multiply-Accumulate)
