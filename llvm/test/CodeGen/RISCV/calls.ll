...
; RV64I-NEXT:    addi sp, sp, -16
; RV64I-NEXT:    sd ra, 8(sp) # 8-byte Folded Spill
; RV64I-NEXT:    call defined_function@plt
; RV64I-NEXT:    ld ra, 8(sp) # 8-byte Folded Reload
; RV64I-NEXT:    addi sp, sp, 16
; RV64I-NEXT:    ret
;
...
; RV64I-SMALL-NEXT:    addi sp, sp, -16
; RV64I-SMALL-NEXT:    sd ra, 8(sp) # 8-byte Folded Spill
; RV64I-SMALL-NEXT:    call defined_function@plt
; RV64I-SMALL-NEXT:    ld ra, 8(sp) # 8-byte Folded Reload
; RV64I-SMALL-NEXT:    addi sp, sp, 16
; RV64I-SMALL-NEXT:    ret
;
...
; RV64I-MEDIUM-NEXT:    addi sp, sp, -16
; RV64I-MEDIUM-NEXT:    sd ra, 8(sp) # 8-byte Folded Spill
; RV64I-MEDIUM-NEXT:    call defined_function@plt
; RV64I-MEDIUM-NEXT:    ld ra, 8(sp) # 8-byte Folded Reload
; RV64I-MEDIUM-NEXT:    addi sp, sp, 16
; RV64I-MEDIUM-NEXT:    ret
;
...
; RV64I-NEXT:    mv s0, a0
; RV64I-NEXT:    call fastcc_function@plt
; RV64I-NEXT:    mv a0, s0
; RV64I-NEXT:    ld ra, 8(sp) # 8-byte Folded Reload
...
; RV64I-SMALL-NEXT:    call fastcc_function@plt
...
; RV64I-MEDIUM-NEXT:    call fastcc_function@plt
...
; RV64I-NEXT:    mv a6, a0
; RV64I-NEXT:    mv a7, a0
; RV64I-NEXT:    call external_many_args@plt
; RV64I-NEXT:    mv a0, s0
...
; RV64I-SMALL-NEXT:    call external_many_args@plt
; RV64I-SMALL-NEXT:    mv a0, s0
...
; RV64I-MEDIUM-NEXT:    call external_many_args@plt
; RV64I-MEDIUM-NEXT:    mv a0, s0
...
; RV64I-NEXT:    mv a6, a0
; RV64I-NEXT:    mv a7, a0
; RV64I-NEXT:    call defined_many_args@plt
; RV64I-NEXT:    ld ra, 24(sp) # 8-byte Folded Reload
; RV64I-NEXT:    addi sp, sp, 32
; RV64I-NEXT:    ret
;
...
; RV64I-SMALL-NEXT:    mv a6, a0
; RV64I-SMALL-NEXT:    mv a7, a0
; RV64I-SMALL-NEXT:    call defined_many_args@plt
; RV64I-SMALL-NEXT:    ld ra, 24(sp) # 8-byte Folded Reload
; RV64I-SMALL-NEXT:    addi sp, sp, 32
; RV64I-SMALL-NEXT:    ret
;
...
; RV64I-MEDIUM-NEXT:    mv a6, a0
; RV64I-MEDIUM-NEXT:    mv a7, a0
; RV64I-MEDIUM-NEXT:    call defined_many_args@plt
; RV64I-MEDIUM-NEXT:    ld ra, 24(sp) # 8-byte Folded Reload
; RV64I-MEDIUM-NEXT:    addi sp, sp, 32
; RV64I-MEDIUM-NEXT:    ret
;
